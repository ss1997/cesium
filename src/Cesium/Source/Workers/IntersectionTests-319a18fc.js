...
define(['exports', './Matrix2-53a99ae0', './when-8166c7dd', './RuntimeError-1ff80201', './Transforms-f4065d1e', './ComponentDatatype-7bff63c1'], (function (exports, Matrix2, when, RuntimeError, Transforms, ComponentDatatype) { 'use strict';
  ...
  IntersectionTests.grazingAltitudeLocation = function (ray, ellipsoid) {
    ...
    const intersects = when.defined(this.rayEllipsoid(ray, ellipsoid));
