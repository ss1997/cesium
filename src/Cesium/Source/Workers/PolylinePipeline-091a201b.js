...
define(['exports', './Matrix2-53a99ae0', './when-8166c7dd', './RuntimeError-1ff80201', './EllipsoidGeodesic-7b8c7e39', './EllipsoidRhumbLine-c657210d', './IntersectionTests-319a18fc', './ComponentDatatype-7bff63c1', './Plane-d60c1860'], (function (exports, Matrix2, when, RuntimeError, EllipsoidGeodesic, EllipsoidRhumbLine, IntersectionTests, ComponentDatatype, Plane) { 'use strict';
  ...
  PolylinePipeline.generateArc = function (options) {
    ...
    let height = when.defaultValue(options.height, 0);
