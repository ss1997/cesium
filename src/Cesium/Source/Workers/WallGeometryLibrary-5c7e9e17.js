...
define(['exports', './arrayRemoveDuplicates-429d63cb', './Matrix2-53a99ae0', './when-8166c7dd', './ComponentDatatype-7bff63c1', './PolylinePipeline-091a201b'], (function (exports, arrayRemoveDuplicates, Matrix2, when, ComponentDatatype, PolylinePipeline) { 'use strict';
  ...
  function removeDuplicates(ellipsoid, positions, topHeights, bottomHeights) {
    ...
    const hasBottomHeights = when.defined(bottomHeights);
    const hasTopHeights = when.defined(topHeights);
