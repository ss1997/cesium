...
define(['exports', './ArcType-0cf52f8c', './arrayRemoveDuplicates-429d63cb', './Matrix2-53a99ae0', './ComponentDatatype-7bff63c1', './when-8166c7dd', './EllipsoidRhumbLine-c657210d', './GeometryAttribute-de44b214', './GeometryAttributes-50becc99', './GeometryPipeline-de9cd92d', './IndexDatatype-61849c3e', './PolygonPipeline-c622c9b3', './Transforms-f4065d1e'], (function (exports, ArcType, arrayRemoveDuplicates, Matrix2, ComponentDatatype, when, EllipsoidRhumbLine, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, PolygonPipeline, Transforms) { 'use strict';
  ...
  PolygonGeometryLibrary.polygonsFromHierarchy = function (
    ...
    while (queue.length !== 0) {
      ...
      const numChildren = when.defined(holes) ? holes.length : 0;
      const polygonHoles = [];
      let j;
