...
define(['exports', './Matrix2-53a99ae0', './RuntimeError-1ff80201', './when-8166c7dd', './ComponentDatatype-7bff63c1'], (function (exports, Matrix2, RuntimeError, when, ComponentDatatype) { 'use strict';
  ...
  function EllipsoidRhumbLine(start, end, ellipsoid) {
    const e = when.defaultValue(ellipsoid, Matrix2.Ellipsoid.WGS84);
    this._ellipsoid = e;
