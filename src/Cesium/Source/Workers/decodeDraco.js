...
define(['./ComponentDatatype-7bff63c1', './when-8166c7dd', './IndexDatatype-61849c3e', './RuntimeError-1ff80201', './createTaskProcessorWorker', './WebGLConstants-7dccdc96'], (function (ComponentDatatype, when, IndexDatatype, RuntimeError, createTaskProcessorWorker, WebGLConstants) { 'use strict';
