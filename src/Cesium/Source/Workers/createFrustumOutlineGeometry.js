...
define(['./when-8166c7dd', './Transforms-f4065d1e', './Matrix2-53a99ae0', './RuntimeError-1ff80201', './ComponentDatatype-7bff63c1', './FrustumGeometry-0cad9248', './GeometryAttribute-de44b214', './GeometryAttributes-50becc99', './combine-ed18558d', './WebGLConstants-7dccdc96', './Plane-d60c1860', './VertexFormat-47fb135f'], (function (when, Transforms, Matrix2, RuntimeError, ComponentDatatype, FrustumGeometry, GeometryAttribute, GeometryAttributes, combine, WebGLConstants, Plane, VertexFormat) { 'use strict';
