...
define(['./Transforms-f4065d1e', './BoxGeometry-22fe37ba', './Matrix2-53a99ae0', './Color-463a67ce', './CylinderGeometry-f779e0e1', './when-8166c7dd', './EllipsoidGeometry-95b5eddb', './IndexDatatype-61849c3e', './createTaskProcessorWorker', './RuntimeError-1ff80201', './ComponentDatatype-7bff63c1', './WebGLConstants-7dccdc96', './combine-ed18558d', './GeometryOffsetAttribute-b8bf80ba', './GeometryAttribute-de44b214', './GeometryAttributes-50becc99', './VertexFormat-47fb135f', './CylinderGeometryLibrary-22ca57dc'], (function (Transforms, BoxGeometry, Matrix2, Color, CylinderGeometry, when, EllipsoidGeometry, IndexDatatype, createTaskProcessorWorker, RuntimeError, ComponentDatatype, WebGLConstants, combine, GeometryOffsetAttribute, GeometryAttribute, GeometryAttributes, VertexFormat, CylinderGeometryLibrary) { 'use strict';
