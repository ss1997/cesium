...
define(['exports', './GeometryOffsetAttribute-b8bf80ba', './Transforms-f4065d1e', './Matrix2-53a99ae0', './ComponentDatatype-7bff63c1', './when-8166c7dd', './RuntimeError-1ff80201', './GeometryAttribute-de44b214', './GeometryAttributes-50becc99', './IndexDatatype-61849c3e'], (function (exports, GeometryOffsetAttribute, Transforms, Matrix2, ComponentDatatype, when, RuntimeError, GeometryAttribute, GeometryAttributes, IndexDatatype) { 'use strict';
  ...
  function EllipsoidOutlineGeometry(options) {
    ...
    const stackPartitions = Math.round(when.defaultValue(options.stackPartitions, 10));
    const slicePartitions = Math.round(when.defaultValue(options.slicePartitions, 8));
    const subdivisions = Math.round(when.defaultValue(options.subdivisions, 128));
