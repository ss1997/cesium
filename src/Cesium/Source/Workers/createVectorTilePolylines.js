...
define(['./Matrix2-53a99ae0', './combine-ed18558d', './AttributeCompression-384003fd', './ComponentDatatype-7bff63c1', './IndexDatatype-61849c3e', './createTaskProcessorWorker', './RuntimeError-1ff80201', './when-8166c7dd', './WebGLConstants-7dccdc96'], (function (Matrix2, combine, AttributeCompression, ComponentDatatype, IndexDatatype, createTaskProcessorWorker, RuntimeError, when, WebGLConstants) { 'use strict';
