...
define(['./when-8166c7dd', './Matrix2-53a99ae0', './RuntimeError-1ff80201', './EllipsoidGeometry-95b5eddb', './VertexFormat-47fb135f', './ComponentDatatype-7bff63c1', './WebGLConstants-7dccdc96', './GeometryOffsetAttribute-b8bf80ba', './Transforms-f4065d1e', './combine-ed18558d', './GeometryAttribute-de44b214', './GeometryAttributes-50becc99', './IndexDatatype-61849c3e'], (function (when, Matrix2, RuntimeError, EllipsoidGeometry, VertexFormat, ComponentDatatype, WebGLConstants, GeometryOffsetAttribute, Transforms, combine, GeometryAttribute, GeometryAttributes, IndexDatatype) { 'use strict';
